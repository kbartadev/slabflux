...
# See accompanying LICENSE and NOTICE files for the integrated terms of use.
# ============================================================================
# Hardware-level Memory Protection (VFIO)
# Isolates the NIC from the kernel and other devices.
#
# 1. Unbind the NIC from the standard driver
echo "0000:01:00.0" > /sys/bus/pci/devices/0000:01:00.0/driver/unbind

# 2. Bind to VFIO-PCI (The Tunnel)
modprobe vfio-pci
echo "vfio-pci" > /sys/bus/pci/devices/0000:01:00.0/driver_override
echo "0000:01:00.0" > /sys/bus/pci/drivers/vfio-pci/bind

echo "[IOMMU] NIC is now physically isolated in a Sandbox."
