...
# See accompanying LICENSE and NOTICE files for the integrated terms of use.
# ============================================================================
# Intel Speed Select (SST-CP) Configuration
# Forces the hardware to prioritize power delivery to our Cores.
#
# Requires 'intel-speed-select' tool
# Set Core 2-5 to 'high' priority level (3)
intel-speed-select -c 2-5 core-config config --level 3

echo "[SILICON] Hardware power priority locked for Cores."
