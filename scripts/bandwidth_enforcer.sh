...
# ============================================================================
#
# Memory Bandwidth Isolation (MBA)
# Restrict non-cores (0,1) to 20% of memory bandwidth.
#
# Requires Intel RDT support (pqos tool)
pqos -e "mba:1=20" # Group 1 (cores 0,1) gets 20%
pqos -a "mba:1=0,1"
pqos -e "mba:0=100" # Group 0 (cores 2-5) gets 100%
pqos -a "mba:0=2-5"

echo "[MBA] Memory bandwidth policy enforced."
