...
# See accompanying LICENSE and NOTICE files for the integrated terms of use.
# ============================================================================
# Split-lock Detection Enforcement
# Ensures no misaligned atomic operations can stall the Core.
#
# Enable fatal split-lock detection in the kernel
echo fatal > /sys/kernel/debug/x86/split_lock_detect

echo "[GUARD] Split-lock detection set to FATAL. Any misalignment will halt the core."
