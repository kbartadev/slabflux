...
# See accompanying LICENSE and NOTICE files for the integrated terms of use.
# ============================================================================
# RCU Housekeeping Offload
# Moves all internal kernel bookkeeping to non-isolated cores.
#
# This must match the 'isolcpus' and 'nohz_full' parameters
# 0-1: Housekeeping, 2-5: (SlabFlux)
for i in $(pgrep rcu); do
    taskset -pc 0,1 $i >/dev/null
done

echo "[KERNEL] RCU callbacks and housekeeping migrated to Core 0-1."
